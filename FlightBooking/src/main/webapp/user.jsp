...
<html>
    ...
    <body>
        ...
        <div class="container-fluid" id="flight-search-module">
            <form action="/index/" method="post">
                <div class="modal-body row g-3">				
                  ...
                  <div class="form-inputs">
                      ...
                      <input type="text" class="form-control" id="travelers" name="travelers" required></div>
                 

                </div>  
                    
                    <div class = "button"> 
                        <button id="button" type="submit" onclick="flight.submitValues(event)">Submit</button><!-- comment --->
                    </div>
...
<!--        <script type="text/javascript">
        ...
        <script type="text/javascript" src="script/findFlights.js"></script>
